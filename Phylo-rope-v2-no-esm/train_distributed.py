...
if __name__ == "__main__":
    ...
    # if ddp is enabled, we need to wrap the datamodule in a DDP wrapper
    ...
    identifier = (
        ...
        f"NB_{args.nb_blocks}_NH_{args.nb_heads}_HD_{args.embed_dim}_PD_{args.project_dim}_"
    ...
    if args.no_improvement_stop is None:
        callbacks.append(
            EarlyStopping(
                monitor="val_loss",
                mode="min",
